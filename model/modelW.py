...
class ResWNet34(nn.Module):
    def __init__(self, seg_classes = 2, colour_classes = 3, fixed_feature=False):
        ...
        self.resnet = resnet34(pretrained=False)  # from model.resnet import resnet34
        self.resnet1 = Resnet34(pretrained=False)  # from model.resnet1 import resnet34 as Resnet34
        if fixed_feature:
