...
class Options:
    def __init__(self, isTrain):
        ...
        self.train['data_dir'] = '{:s}/data_for_train/{:s}'.format(self.rootDir, self.dataset)  # path to data
        self.train['save_dir'] = '{:s}/{:s}/save'.format(self.rootDir, self.dataset)  # path to save results
        self.train['input_size'] = 224          # input size of the image
        self.train['train_epochs'] = 100         # number of training epochs
        self.train['batch_size'] = 2            # batch size
        ...
        self.test['gpus'] = [0, ]
        self.test['img_dir'] = '{:s}/data_for_train/{:s}/images/test'.format(self.rootDir, self.dataset)
